        ...
        <div class="row">
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14">1200 ratings | 100+ answered questions</a>
                </div>
                <hr class="m-0">
                ...
                <div id="policy">
                    <div class="d-flex">
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">07 Days <br> Replacement</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-truck  border p-3 rounded-pill"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">SmartHomebd <br>Deliverd</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">SmartHomeBd </a>(4.5 out of 5 | 100+ ratings)</small>
